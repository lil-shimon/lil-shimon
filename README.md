...
こんにちは、lil-shimonです。  
大学4年時のインターンから6年エンジニアをしています。  

2年間の正社員経験後、フリーランスエンジニアとして活動しています。

---

## 生成AIを活用した開発スタイル

日常の開発において生成AIツールを積極的に活用し、高速かつ効率的な開発を実現しています。

### 最近の開発スタイル
- git worktreeを使ってClaude Codeと並行開発することで、複数の機能を効率的に実装
- Cursorでコード補完を使いながらスピード感のある開発を実践
- 技術選定などで多くの情報を調べる必要がある時はDeep Researchを使って効率的に調査

生成AIは単なるツールではなく、開発生産性を飛躍的に向上させるパートナーとして活用しています。
...
Webフロントエンドを軸としたフルスタック開発から開発支援・アドバイザリーまで幅広く対応しています。

#### 動画配信プラットフォームのフルスタック開発
- スタートアップ企業にて、WebフロントエンドからLambdaによる外部システム連携まで担当  
- バックエンドのアーキテクチャ設計・立ち上げも主導

#### フリーランスエンジニア向けエージェントサービスの開発
- 自社サービスを展開するスタートアップにてWebフロントエンドの開発を担当  
- Next.js、GraphQL、GitHub Actionsなどを活用したモダンな開発環境の中で、開発生産性や属人化の解消を意識したチーム体制を経験  
